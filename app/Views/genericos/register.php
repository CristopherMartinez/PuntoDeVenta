    ...
    <script src='https://www.google.com/recaptcha/api.js'></script>
     ...
     <body class="imgregister letraGeneral" style="color:whitesmoke">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
            <h2 class="text-center mb-4" style="color:whitesmoke">REGISTRATE</h2>
            <form method="POST" action="#">
                ...
                <div class="mb-3">
                <label for="contrasena" class="form-label">Correo electrónico</label>
                ...
                <div class="mb-3">
                <label for="contrasena" class="form-label">Repite contraseña</label>
                <input type="password" class="form-control" id="contrasena" name="contrasena" required>
                </div>
                <div class="form-check d-flex justify-content-center mb-5">
                  <input class="form-check-input me-2" type="checkbox" value="" id="form2Example3cg" />
