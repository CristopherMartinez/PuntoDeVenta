<!-- <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <a class="navbar-brand" href="inicio" style="padding-left:10px;"><img src="<?php  echo base_url()?>/imagenes/logoWorld.png" class="logoWorld"></a>
    <button class="navbar-toggler" type="button"" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"><a class="nav-link"> <img src="<?php  echo base_url()?>/imagenes/icons/menu3.png" style="width:30px"></a></span>
    </button>
       ...
       <li class="nav-item">
        ...
        <a class="navbar-brand" href="inicio" style="padding-left:5px;"><img src="<?php  echo base_url()?>/imagenes/logoWorld.png" class="logoWorld"></a>
            ...
            <form class="d-flex">
                ...
                <button class="btn btn-outline-success" type="submit" style="padding-left: 5px;">Search</button>
            </form>
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll letraNavbar" style="--bs-scroll-height: 100px;">
              <li class="nav-item">
