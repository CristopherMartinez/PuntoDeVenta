            ...
            <div class="collapse navbar-collapse" id="navbarScroll" style="padding-left: 0px;">
              <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                  ...
                  <?php
                    if(isset($_SESSION)) {
                        ...
                        if($currentPage == '/Codeigniter4/usuario/inicio') {
                            echo '<a class="nav-link active" aria-current="page" href="#nosotros" style="padding-left: 5px;">Nosotros</a>';
                        } else {
                            echo '<a class="nav-link active" aria-current="page" href="' . base_url() . '/usuario/inicio#nosotros" style="padding-left: 5px;">Nosotros</a>';
                        }
                    }
                  ?>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu navVideo" style="background-color: transparent; font-weight:bolder; opacity:.95;">
                      <!-- <li><a class="dropdown-item" href="playVideogames" style="padding-left: 5px;">Jugar</a></li> -->
